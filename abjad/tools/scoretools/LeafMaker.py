...
class LeafMaker(AbjadValueObject):
    ...
    ..  container:: example
        ...
        You may set `forbidden_written_duration` and `decrease_monotonic`
        together:
    ...
    def __call__(self, pitches, durations):
        ...
        for duration_group in duration_groups:
            ...
            if len(factors) == 0:
                ...
                if self.is_diminution and not tuplet.is_diminution:
    ...
    def _make_tied_leaf(
        ...
        if forbidden_written_duration is not None:
            forbidden_written_duration = abjad.Duration(
        ...
        if (forbidden_written_duration is not None and
            ...
            forbidden_written_duration = abjad.NonreducedFraction(
                forbidden_written_duration)
            forbidden_written_duration = \
